...
public class AnimalManager {
	...
	public static void main(String[] args) {
		...
		for(int j = 0; j < 10; j++) { // for문을 이용해 5개의 숫자를 섞어준다.  
		...
		for(int i = 0; i< a.length; i++) {  // Animal 객체배열을 초기화 하기위한 for문
			...
			if(rNum2 == 1) { 
				...
				case 0 : a[intNum[i]] = new Cat("나비","스핑크스고양이","명심산","살색"); break;
				case 1 : a[intNum[i]] = new Cat("복자","샴고양이","구로동","쥐색"); break;
				case 2 : a[intNum[i]] = new Cat("아리","러시안블루","자이아파트 주차장","노랑색"); break;
				case 3 : a[intNum[i]] = new Cat("쫀덕이","먼치킨","쫀덕빵집","하양색"); break;
				case 4 : a[intNum[i]] = new Cat("삼색이","싱가푸라","황학산","고등어색"); break;
				}
			}else if(rNum2 == 2){ 
				switch(intNum[i]) {
				case 0 : a[intNum[i]] = new Dog("밍키","불독",23); break;
				case 1 : a[intNum[i]] = new Dog("코코","푸들",5); break;
				case 2 : a[intNum[i]] = new Dog("쿠키","프렌치 불독",11); break;
				case 3 : a[intNum[i]] = new Dog("뽀삐","웰시코기",8); break;
				case 4 : a[intNum[i]] = new Dog("멍멍","시츄",23); break;
				}
			}// 다섯 칸 모두 초기화 끝
		}
